...
for(i in 17:20){
  rt_traj[[i]] <- read_latest("data", "choleraRt_sine")}

sim_data <- list()

# Scenario 1 - Rt const low, rt_opts=latest, under-reporting=no
sim_data[[1]] <- read_latest(here("data"), "cholera_sim_data_const_low")
# Scenario 2 - Rt const low, rt_opts=latest, under-reporting=yes
sim_data[[2]] <- read_latest(here("data"), "cholera_sim_data_const_low_ur")
# Scenario 3 - Rt const low, rt_opts=project, ur=no
sim_data[[3]] <- read_latest(here("data"), "cholera_sim_data_const_low")
# Scenario 4 - Rt const low, rt_opts=project, ur=yes
sim_data[[4]] <- read_latest(here("data"), "cholera_sim_data_const_low_ur")

# Scenario 5 - Rt const high, rt_opts=latest, under-reporting=no
sim_data[[5]] <- read_latest(here("data"), "cholera_sim_data_const_hi")
# Scenario 6 - Rt const high, rt_opts=latest, under-reporting=yes
sim_data[[6]] <- read_latest(here("data"), "cholera_sim_data_const_hi_ur")
# Scenario 7 - Rt const high, rt_opts=project, under-reporting=no 
sim_data[[7]] <- read_latest(here("data"), "cholera_sim_data_const_hi")
# Scenario 8 - Rt const high, rt_opts=project, under-reporting=yes
sim_data[[8]] <- read_latest(here("data"), "cholera_sim_data_const_hi_ur")

# Scenario 9 - Rt inc, rt_opts=latest, under-reporting=no
sim_data[[9]] <- read_latest(here("data"), "cholera_sim_data_inc")
# Scenario 10 - Rt inc, rt_opts=latest, under-reporting=yes
sim_data[[10]] <- read_latest(here("data"), "cholera_sim_data_inc_ur")
# Scenario 11 - Rt inc, rt_opts=project, under-reporting=no
sim_data[[11]] <- read_latest(here("data"), "cholera_sim_data_inc")
# Scenario 12 - Rt inc, rt_opts=project, under-reporting=yes
sim_data[[12]] <- read_latest(here("data"), "cholera_sim_data_inc_ur")

# Scenario 13 - Rt dec, rt_opts=latest, under-reporting=no
sim_data[[13]] <- read_latest(here("data"), "cholera_sim_data_dec")
# Scenario 14 - Rt dec, rt_opts=latest, under-reporting=yes
sim_data[[14]] <- read_latest(here("data"), "cholera_sim_data_dec_ur")
# Scenario 15 - Rt dec, rt_opts=project, under-reporting=no 
sim_data[[15]] <- read_latest(here("data"), "cholera_sim_data_dec")
# Scenario 16 - Rt dec, rt_opts=project, under-reporting=yes
sim_data[[16]] <- read_latest(here("data"), "cholera_sim_data_dec_ur")

# Scenario 17 - Rt sine, rt_opts=latest, under-reporting=no
sim_data[[17]] <- read_latest(here("data"), "cholera_sim_data_sine")
# Scenario 18 - Rt sine, rt_opts=latest, under-reporting=yes
sim_data[[18]] <- read_latest(here("data"), "cholera_sim_data_sine_ur")
# Scenario 19 - Rt sine, rt_opts=project, under-reporting=no
sim_data[[19]] <- read_latest(here("data"), "cholera_sim_data_sine")
# Scenario 20 - Rt sine, rt_opts=project, under-reporting=yes
sim_data[[20]] <- read_latest(here("data"), "cholera_sim_data_sine_ur")

## Save ##

save_latest(rt_traj, here("data"), "rt_traj_list_cholera")
save_latest(sim_data, here("data"), "sim_data_list_cholera")
