...
save_latest(res_covid[[3]], here("results"), paste0("res_covidscen21_R", gt))
save_latest(res_covid[[4]], here("results"), paste0("res_covidscen21_summary", gt))
save_latest(res_covid[[5]], here("results"), paste0("res_covidscen21_warnings", gt))

res_summaries <- readRDS(here("results", paste0("res_", disease, "scen21_warnings42025-01-08.rds")))
...
## Run scenario 22 - rt_opts=latest, under-reporting=yes ##
  ...
  save_latest(res_covid[[3]], here("results"), paste0("res_covidscen22_R", gt))
  save_latest(res_covid[[4]], here("results"), paste0("res_covidscen22_summary", gt))
  save_latest(res_covid[[5]], here("results"), paste0("res_covidscen22_warnings", gt))
...
## Run scenario 23 - rt_opts=project, under-reporting=no ##
  ...
  save_latest(res_covid[[3]], here("results"), paste0("res_covidscen23_R", gt))
  save_latest(res_covid[[4]], here("results"), paste0("res_covidscen23_summary", gt))
  save_latest(res_covid[[5]], here("results"), paste0("res_covidscen23_warnings", gt))
...
## Run scenario 24 - rt_opts=project, under-reporting=yes ##
  ...
  save_latest(res_covid[[3]], here("results"), paste0("res_covidscen24_R", gt))
  save_latest(res_covid[[4]], here("results"), paste0("res_covidscen24_summary", gt))
  save_latest(res_covid[[5]], here("results"), paste0("res_covidscen24_warnings", gt))
