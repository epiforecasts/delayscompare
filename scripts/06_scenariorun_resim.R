...
save_latest(res_disease[[1]], here("results"), paste0("res_", disease, "_sim_", rt_opts, "_samples", gt))
save_latest(res_disease[[2]], here("results"), paste0("res_", disease, "_sim_", rt_opts, "_id", gt))
save_latest(res_disease[[3]], here("results"), paste0("res_", disease, "_sim_", rt_opts, "_R", gt))
save_latest(res_disease[[4]], here("results"), paste0("res_", disease, "_sim_", rt_opts, "_summary", gt))
save_latest(res_disease[[5]], here("results"), paste0("res_", disease, "_sim_", rt_opts, "_warnings", gt))