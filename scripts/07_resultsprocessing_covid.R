...
save_latest(covid_id, here("results"), paste0("res_covidscen", i, "_all_id"))
save_latest(covid_R, here("results"), paste0("res_covidscen", i, "_all_R"))
save_latest(covid_samples, here("results"), paste0("res_covidscen", i, "_all_samples"))
save_latest(covid_warnings, here("results"), paste0("res_covidscen", i, "_all_warnings"))
